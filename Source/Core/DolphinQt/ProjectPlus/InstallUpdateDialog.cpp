...
void InstallUpdateDialog::install()
{
  ...
  QString extractDirectory = this->temporaryDirectory + QDir::separator() + QStringLiteral("Project-Plus-All-Stars-Dolphin");
  ...
  if (this->filename.endsWith(QStringLiteral(".zip")))
  {
    ...
    {
      if (!dir.mkdir(QStringLiteral("Project-Plus-All-Stars-Dolphin")))
      {
