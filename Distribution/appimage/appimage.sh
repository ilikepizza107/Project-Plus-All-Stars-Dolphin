...
curl -sL https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Data/project-plus-dolphin.svg -o ./squashfs-root/project-plus-dolphin.svg
curl -sL https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Data/project-plus-dolphin.desktop -o ./squashfs-root/project-plus-dolphin.desktop
