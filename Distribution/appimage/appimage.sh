...
BINFILE=Project+_All-Stars_Dolphin-x86_64.AppImage
...
cp -P "$BUILDBIN"/project-plus-all-stars-dolphin $HOME/squashfs-root/usr/bin/

curl -sL https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Data/project-plus-all-stars-dolphin.svg -o ./squashfs-root/project-plus-all-stars-dolphin.svg
curl -sL https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Data/project-plus-all-stars-dolphin.desktop -o ./squashfs-root/project-plus-all-stars-dolphin.desktop
curl -sL https://github.com/AppImage/AppImageKit/releases/download/continuous/runtime-x86_64 -o ./squashfs-root/runtime
mkdir -p squashfs-root/usr/share/applications && cp ./squashfs-root/project-plus-all-stars-dolphin.desktop ./squashfs-root/usr/share/applications
mkdir -p squashfs-root/usr/share/icons && cp ./squashfs-root/project-plus-all-stars-dolphin.svg ./squashfs-root/usr/share/icons
mkdir -p squashfs-root/usr/share/icons/hicolor/scalable/apps && cp ./squashfs-root/project-plus-all-stars-dolphin.svg ./squashfs-root/usr/share/icons/hicolor/scalable/apps
mkdir -p squashfs-root/usr/share/pixmaps && cp ./squashfs-root/project-plus-all-stars-dolphin.svg ./squashfs-root/usr/share/pixmaps
mkdir -p squashfs-root/usr/optional/ ; mkdir -p squashfs-root/usr/optional/libstdc++/

mkdir -p squashfs-root/usr/share/project-plus-all-stars-dolphin
cp -R /dolphin/dolphin/Data/Sys ./squashfs-root/usr/bin
curl -sL "https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Distribution/appimage/update.sh" -o $HOME/squashfs-root/update.sh
curl -sL "https://raw.githubusercontent.com/ilikepizza107/Project-Plus-All-Stars-Dolphin/$branch/Distribution/appimage/AppRun" -o $HOME/squashfs-root/AppRun
...
# Package AppImage
/tmp/squashfs-root/usr/bin/appimagetool $HOME/squashfs-root -u "gh-releases-zsync|qurious-pixel|dolphin|continuous|Project+_All-Stars_Dolphin-x86_64.AppImage.zsync"

mkdir $HOME/artifacts/
mkdir -p /dolphin/artifacts/
mv Project+_All-Stars_Dolphin-x86_64.AppImage* $HOME/artifacts
cp -R $HOME/artifacts/ /dolphin/
cp $BUILDBIN/project-plus-all-stars-dolphin /dolphin/artifacts
